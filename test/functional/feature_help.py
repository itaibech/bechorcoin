...
"""Verify that starting bechorcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bechorcoin with -h for help text")
        ...
        self.log.info("Start bechorcoin with -version for version information")
        ...
        self.log.info("Start bechorcoind with -fakearg to make sure it does not start")
