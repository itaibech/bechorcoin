# Support for Output Descriptors in bechorcoin Core

Since bechorcoin Core v0.17, there is support for Output Descriptors. This is a
...
on bechorcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing bechorcoin Core wallets, a convenience function `combo` is
