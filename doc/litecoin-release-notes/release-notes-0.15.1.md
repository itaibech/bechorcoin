bechorcoin Core version *0.15.1* is now available from:

  <https://download.bechorcoin.org/bechorcoin-0.15.1/>
...
A number of changes to the way bechorcoin Core deals with peer connections and invalid blocks
