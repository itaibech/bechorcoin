...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.bechorcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.bechorcointools.com");
        vSeeds.emplace_back("dnsseed.bechorcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bechorcointools.com");
        vSeeds.emplace_back("seed-b.bechorcoin.loshan.co.uk");
