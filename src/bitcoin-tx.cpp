...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bechorcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bechorcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bechorcoin transaction\n" +
            "or:     bechorcoin-tx [options] -create [commands]   Create hex-encoded bechorcoin transaction\n" +
            "\n";
